...
enum FlowAirport: String, CaseIterable, Identifiable, Codable, Hashable {
    ...
    var displayName: String {
        ...
        case .ber: return "Berlin Brandenburg"
    ...
    var shortName: String {
        ...
        case .cle: return "Clevelend (CLE)"
        case .pit: return "Pittsburgh (PIT)"
        ...
        case .ber: return "Berlin Brandenburg (BER)"
